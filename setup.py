...
setup(
    ...
    packages=['eteutils', 'loadtest', 'pstutils'],       # The name of your scripts package
    package_dir={'eteutils': 'eteutils', 'loadtest': 'loadtest', 'pstutils': 'pstutils'}, # The location of your scipts package
    classifiers=[
